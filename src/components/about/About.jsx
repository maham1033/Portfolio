    ...
    <section id='about'>
      ...
      <div className="container about__container">
        ...
        <div className="about__content">
         <p>Hi, I’m Maham Nadeem, a frontend developer and Computer Engineering student at UET Lahore. I’m passionate about crafting responsive and user-friendly web interfaces using HTML, CSS, JavaScript, and React. Currently, I’m expanding my skills into full-stack development with the MERN stack, aiming to build dynamic web applications that make a difference.
